import { t as AuthProvider } from "./AuthContext-BQtB4ALz.js";
import { c as whatsappLink, o as site } from "./site-Dg0SHnY9.js";
import { t as dillkash_logo_horizontal_default } from "./dillkash-logo-horizontal-gZmcQUGi.js";
import { n as WhatsAppIcon, t as Navbar } from "./Navbar-P14Io8Rd.js";
import { t as Route$20 } from "./packages.index-zYMGNX-m.js";
import { t as Route$21 } from "./packages._slug-DE8ZbPFw.js";
import { t as Route$22 } from "./destinations._id.edit-BDOFnhO7.js";
import { t as Route$23 } from "./hotels._id.edit-BUTCSOlB.js";
import { t as Route$24 } from "./packages._id.edit-mh7s_jzB.js";
...
function SocialGlyph({ icon }) {
	const cls = "h-4 w-4";
	switch (icon) {
		case "f": return /* @__PURE__ */ jsx("svg", {
			className: cls,
			viewBox: "0 0 24 24",
			fill: "currentColor",
			"aria-hidden": true,
			children: /* @__PURE__ */ jsx("path", { d: "M22 12a10 10 0 1 0-11.56 9.88v-6.99H7.9V12h2.54V9.8c0-2.5 1.5-3.89 3.78-3.89 1.09 0 2.24.2 2.24.2v2.46H15.2c-1.24 0-1.63.77-1.63 1.56V12h2.78l-.45 2.89h-2.33v6.99A10 10 0 0 0 22 12Z" })
		});
		case "ig": return /* @__PURE__ */ jsx("svg", {
			className: cls,
			viewBox: "0 0 24 24",
			fill: "currentColor",
			"aria-hidden": true,
			children: /* @__PURE__ */ jsx("path", { d: "M12 2.16c3.2 0 3.58.01 4.85.07 3.25.15 4.77 1.69 4.92 4.92.06 1.27.07 1.65.07 4.85s-.01 3.58-.07 4.85c-.15 3.23-1.66 4.77-4.92 4.92-1.27.06-1.65.07-4.85.07s-3.58-.01-4.85-.07c-3.26-.15-4.77-1.7-4.92-4.92C2.17 15.58 2.16 15.2 2.16 12s.01-3.58.07-4.85C2.38 3.92 3.9 2.38 7.15 2.23 8.42 2.17 8.8 2.16 12 2.16ZM12 7a5 5 0 1 0 0 10 5 5 0 0 0 0-10Zm0 8.25A3.25 3.25 0 1 1 12 8.75a3.25 3.25 0 0 1 0 6.5Zm6.4-9.65a1.17 1.17 0 1 1-2.34 0 1.17 1.17 0 0 1 2.34 0Z" })
		});
		case "tt": return /* @__PURE__ */ jsx("svg", {
			className: cls,
			viewBox: "0 0 24 24",
			fill: "currentColor",
			"aria-hidden": true,
			children: /* @__PURE__ */ jsx("path", { d: "M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.9 2.9 0 1 1-2.31-2.84V9.35a6.35 6.35 0 1 0 5.76 6.32V8.69a8.16 8.16 0 0 0 4.77 1.52V6.75c-.61 0-1.2-.02-1-.06Z" })
		});
		default: return /* @__PURE__ */ jsx("svg", {
			...
			fill: "currentColor",
			"aria-hidden": true,
			children: /* @__PURE__ */ jsx("path", { d: "M23.5 6.19a3.02 3.02 0 0 0-2.12-2.14C19.5 3.55 12 3.55 12 3.55s-7.5 0-9.38.5A3.02 3.02 0 0 0 .5 6.19C0 8.07 0 12 0 12s0 3.93.5 5.81a3.02 3.02 0 0 0 2.12 2.14c1.88.5 9.38.5 9.38.5s7.5 0 9.38-.5a3.02 3.02 0 0 0 2.12-2.14C24 15.93 24 12 24 12s0-3.93-.5-5.81ZM9.55 15.57V8.43L15.82 12l-6.27 3.57Z" })
		});
	}
}
function Footer() {
			...
			children: [
				/* @__PURE__ */ jsxs("div", { children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: socials.map((s) => /* @__PURE__ */ jsx("a", {
							...
							children: /* @__PURE__ */ jsx(SocialGlyph, { icon: s.icon })
						}, s.label))
					})
				] }),
				/* @__PURE__ */ jsxs("nav", {
					...
					children: [/* @__PURE__ */ jsx("h3", {
						...
						children: companyLinks.map((l) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, {
							to: l.href,
				...
				/* @__PURE__ */ jsxs("nav", {
					...
					children: [/* @__PURE__ */ jsx("h3", {
						...
						className: "mt-4 space-y-2.5",
						children: destinationLinks.map((d) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, {
							to: "/packages",
							className: "text-sm text-primary-foreground/70 transition-colors hover:text-primary",
							children: d
						}) }, d))
					...
					children: [
						...
						/* @__PURE__ */ jsxs("li", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								className: "shrink-0 text-primary",
								children: /* @__PURE__ */ jsx(WhatsAppIcon, { size: 16 })
							}), /* @__PURE__ */ jsx("a", {
								href: whatsappLink(),
								target: "_blank",
								rel: "noopener noreferrer",
...
function WhatsAppFloat() {
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("a", {
		...
		children: /* @__PURE__ */ jsx(WhatsAppIcon, { size: 28 })
	}), /* @__PURE__ */ jsx("div", {
...
function RootComponent() {
	...
	return /* @__PURE__ */ jsx(AuthProvider, { children: /* @__PURE__ */ jsxs(QueryClientProvider, {
		...
		children: [
			...
			!isAdmin && !isAuth && /* @__PURE__ */ jsx(WhatsAppFloat, {})
		]
	}) });
}
//#endregion
//#region src/routes/index.tsx
var $$splitComponentImporter$18 = () => import("./routes-Cy8WuoE3.js");
...
var $$splitComponentImporter$17 = () => import("./about-DIe8RZCo.js");
...
var $$splitComponentImporter$16 = () => import("./admin-CVf9cffi.js");
...
var $$splitComponentImporter$15 = () => import("./contact-Bd61sCyJ.js");
...
//#endregion
//#region src/routes/custom-tour.tsx
var $$splitComponentImporter$14 = () => import("./custom-tour-Cri-aO2g.js");
...
//#endregion
//#region src/routes/hotels.tsx
var $$splitComponentImporter$13 = () => import("./hotels-BRjLjUZa.js");
...
var $$splitComponentImporter$12 = () => import("./login-DPeEuHEH.js");
...
//#endregion
//#region src/routes/packages.tsx
var $$splitComponentImporter$11 = () => import("./packages-BNLFs_o1.js");
...
var $$splitComponentImporter$10 = () => import("./signup-Cj6xWhIK.js");
...
var $$splitComponentImporter$9 = () => import("./admin-B87SpIcx.js");
...
var $$splitComponentImporter$8 = () => import("./hotels-tVSrouNF.js");
var Route$8 = createFileRoute("/admin/hotels")({ component: lazyRouteComponent($$splitComponentImporter$8, "component") });
//#endregion
//#region src/routes/admin/packages.tsx
var $$splitComponentImporter$7 = () => import("./packages-DB8lF8K3.js");
var Route$7 = createFileRoute("/admin/packages")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
//#endregion
//#region src/routes/admin/destinations.index.tsx
var $$splitComponentImporter$6 = () => import("./destinations.index-Dlxc-Vn6.js");
var Route$6 = createFileRoute("/admin/destinations/")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
//#endregion
//#region src/routes/admin/destinations.create.tsx
var $$splitComponentImporter$5 = () => import("./destinations.create-7OYcZFDT.js");
var Route$5 = createFileRoute("/admin/destinations/create")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
//#endregion
//#region src/routes/admin/guides.index.tsx
var $$splitComponentImporter$4 = () => import("./guides.index-Fl5fR4H1.js");
var Route$4 = createFileRoute("/admin/guides/")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
//#endregion
//#region src/routes/admin/hotels.index.tsx
var $$splitComponentImporter$3 = () => import("./hotels.index-BcEhBPNF.js");
var Route$3 = createFileRoute("/admin/hotels/")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
//#endregion
//#region src/routes/admin/hotels.create.tsx
var $$splitComponentImporter$2 = () => import("./hotels.create-CHRIo6tH.js");
var Route$2 = createFileRoute("/admin/hotels/create")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
//#endregion
//#region src/routes/admin/packages.index.tsx
var $$splitComponentImporter$1 = () => import("./packages.index-262ZoTxW.js");
var Route$1 = createFileRoute("/admin/packages/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
//#endregion
//#region src/routes/admin/packages.create.tsx
var $$splitComponentImporter = () => import("./packages.create-Cktd6Cqu.js");
...
var PackagesSlugRoute = Route$21.update({
	id: "/$slug",
	path: "/$slug",
	getParentRoute: () => PackagesRoute
});
...
var AdminDestinationsIdEditRoute = Route$22.update({
	id: "/destinations/$id/edit",
	path: "/destinations/$id/edit",
	getParentRoute: () => AdminRoute
});
var AdminHotelsIdEditRoute = Route$23.update({
	id: "/$id/edit",
	path: "/$id/edit",
	getParentRoute: () => AdminHotelsRoute
});
var AdminPackagesIdEditRoute = Route$24.update({
	id: "/$id/edit",
	path: "/$id/edit",
	getParentRoute: () => AdminPackagesRoute
});
