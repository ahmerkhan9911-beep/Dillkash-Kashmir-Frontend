import { t as GalleryUploader } from "./GalleryUploader-TO0YaacD.js";
import { n as HOTEL_LOCATIONS, t as HOTEL_AMENITIES } from "./hotels-BRLCSHY7.js";
import { useCallback, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { Loader2, Save, Star, X } from "lucide-react";
//#region src/components/admin/HotelForm.tsx
var emptyForm = {
	name: "",
	location: "",
	starRating: 3,
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
					...
					}), HOTEL_LOCATIONS.map((loc) => /* @__PURE__ */ jsx("option", {
						value: loc,
						children: loc
					}, loc))]
				})] })]
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("button", {
						...
						}) : /* @__PURE__ */ jsx(Save, { size: 18 }), loading ? "Saving..." : submitLabel]
					}),
					onCancel && /* @__PURE__ */ jsxs("button", {
						type: "button",
						onClick: onCancel,
						...
						children: [/* @__PURE__ */ jsx(X, { size: 18 }), "Cancel"]
					}),
					uploadingCount > 0 && /* @__PURE__ */ jsxs("span", {
