...
import { ChevronLeft, Hotel, LayoutDashboard, Loader2, LogOut, MapPin, Menu, Package, ShieldAlert, UserCheck } from "lucide-react";
//#region src/components/admin/AdminSidebar.tsx
var links = [
	{
		to: "/admin",
		label: "Dashboard",
...
function AdminSidebar() {
	...
	const sidebarContent = /* @__PURE__ */ jsxs(Fragment, { children: [
		/* @__PURE__ */ jsxs("div", {
			...
			children: [collapsed ? /* @__PURE__ */ jsx("img", {
		...
		/* @__PURE__ */ jsx("nav", {
			...
			children: links.map((l) => {
				...
				return /* @__PURE__ */ jsxs(Link, {
					...
					children: [/* @__PURE__ */ jsx(l.icon, { size: 20 }), !collapsed && /* @__PURE__ */ jsx("span", { children: l.label })]
				}, l.to);
			})
		}),
		/* @__PURE__ */ jsxs("div", {
			...
			children: [
				!collapsed && user && /* @__PURE__ */ jsxs("div", {
					className: "mb-3 px-4",
				...
				/* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx(LogOut, { size: 20 }), !collapsed && /* @__PURE__ */ jsx("span", { children: "Logout" })]
				}),
				/* @__PURE__ */ jsxs(Link, {
					to: "/",
					...
					children: [/* @__PURE__ */ jsx(ChevronLeft, { size: 20 }), !collapsed && /* @__PURE__ */ jsx("span", { children: "Back to Website" })]
				})
			]
		})
	] });
...
function AdminLayout() {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx(ShieldAlert, { size: 32 })
				}),
				/* @__PURE__ */ jsx("h1", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(AdminSidebar, {}), /* @__PURE__ */ jsx("div", {
			className: "lg:pl-64",
