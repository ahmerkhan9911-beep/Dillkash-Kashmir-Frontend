import { c as whatsappLink, s as tours } from "./site-Bb-6ZWDl.js";
import { t as cn } from "./utils-C_uf36nf.js";
import { n as WhatsAppIcon } from "./Navbar-CwNINFgT.js";
import { useEffect, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { Star, X } from "lucide-react";
//#region src/components/site/StarRating.tsx
...
//#endregion
//#region src/components/site/BookingModal.tsx
var initial = {
	name: "",
	phone: "",
	tour: "",
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [
							...
							/* @__PURE__ */ jsxs("select", {
								...
								}), tours.map((t) => /* @__PURE__ */ jsx("option", {
									value: t.title,
									children: t.title
								}, t.slug))]
							}),
							errors.tour && /* @__PURE__ */ jsx("p", {
								className: "mt-1 text-xs font-medium text-destructive",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
								...
								className: inputCls(),
								children: [
									/* @__PURE__ */ jsx("option", { children: "Standard Double" }),
									/* @__PURE__ */ jsx("option", { children: "Family Room" }),
									/* @__PURE__ */ jsx("option", { children: "Deluxe Double" }),
									/* @__PURE__ */ jsx("option", { children: "Shared (Budget)" })
								]
							})] })
						]
					}),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("button", {
							...
							children: [/* @__PURE__ */ jsx(WhatsAppIcon, { size: 18 }), "Book via WhatsApp"]
						})]
					})
				]
			})]
