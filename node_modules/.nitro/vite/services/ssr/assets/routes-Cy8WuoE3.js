import { a as reviews, c as whatsappLink, i as pickupPoints, r as images, s as tours, t as destinations } from "./site-Dg0SHnY9.js";
import { n as WhatsAppIcon } from "./Navbar-P14Io8Rd.js";
import { t as Reveal } from "./Reveal-CRQyoRRE.js";
import { t as SectionHeader } from "./SectionHeader-C9AT2Ppx.js";
import { a as getDestinations } from "./destinations-DX0_kpyq.js";
import { n as StarRating, t as BookingModal } from "./BookingModal-71ZBzTEs.js";
import { t as TourCard } from "./TourCard-DhgRpgwQ.js";
import { useCallback, useEffect, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, BadgeCheck, BedDouble, Bus, Camera, ChevronLeft, ChevronRight, HandPlatter, HeartHandshake, Images, MapPin, Mountain, Play, Search, ShieldCheck, Users, Wallet, X } from "lucide-react";
//#region src/components/site/DestinationGalleryModal.tsx
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("span", {
								...
								children: [/* @__PURE__ */ jsx(MapPin, { size: 12 }), "Azad Kashmir"]
							}),
							/* @__PURE__ */ jsx("h2", {
					...
					}), destination.description && /* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [images.length > 0 ? /* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx("p", { children: "No photos available for this destination." })
			...
			images.length > 1 && /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx("div", {
					...
					children: images.map((img, idx) => /* @__PURE__ */ jsx("button", {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-black/50 via-black/25 to-black/60" }),
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs(Reveal, { children: [
						/* @__PURE__ */ jsxs("span", {
							...
							children: [/* @__PURE__ */ jsx(Mountain, { size: 14 }), "Weekly Departures from Lahore"]
						}),
						/* @__PURE__ */ jsx("h1", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs(Link, {
								...
								children: ["Explore Kashmir Tours", /* @__PURE__ */ jsx(ArrowRight, { size: 16 })]
							}), /* @__PURE__ */ jsxs("a", {
								href: whatsappLink(),
								target: "_blank",
								...
								children: [/* @__PURE__ */ jsx(WhatsAppIcon, { size: 18 }), "Book on WhatsApp"]
							})]
						})
					] })
				})
				...
				children: /* @__PURE__ */ jsxs("form", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
							...
							children: [
								/* @__PURE__ */ jsx("option", { children: "3 Days" }),
								/* @__PURE__ */ jsx("option", { children: "5 Days" }),
						...
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("option", { children: "Couples" }),
								/* @__PURE__ */ jsx("option", { children: "Group" }),
						...
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
							...
							children: /* @__PURE__ */ jsx("option", { children: "Lahore" })
						})] }),
						/* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx(Search, { size: 16 }), "Search Tours"]
						})
					]
				})
			})
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx("span", {
							...
							children: /* @__PURE__ */ jsx(f.icon, { size: 26 })
						}),
						/* @__PURE__ */ jsx("h3", {
...
function PopularPackages({ onBook }) {
	const [featured, setFeatured] = useState(tours.filter((t) => t.featured));
	useEffect(() => {
		import("./packages-BApqLpSW.js").then(({ getPackages }) => {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: featured.map((t, i) => /* @__PURE__ */ jsx(Reveal, {
						delay: i * 80,
				...
				/* @__PURE__ */ jsx(Reveal, {
					...
					children: /* @__PURE__ */ jsxs(Link, {
						...
						children: ["View All Kashmir Packages", /* @__PURE__ */ jsx(ArrowRight, { size: 16 })]
					})
				})
			]
		})
...
function Destinations() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				className: "mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4",
				children: displayDestinations.map((d, i) => /* @__PURE__ */ jsx(Reveal, {
					delay: i % 4 * 70,
			...
			/* @__PURE__ */ jsx(DestinationGalleryModal, {
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(SectionHeader, {
				...
				className: "mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4",
				children: inclusions.map((f, i) => /* @__PURE__ */ jsx(Reveal, {
					delay: i % 4 * 70,
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							children: /* @__PURE__ */ jsx(f.icon, { size: 22 })
						}), /* @__PURE__ */ jsxs("div", {
							className: "min-w-0",
				...
				children: /* @__PURE__ */ jsxs(Reveal, { children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs(Link, {
							...
							children: ["Explore Packages", /* @__PURE__ */ jsx(ArrowRight, { size: 16 })]
						})
					})
				] })
			})
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx("div", {
						...
						children: reviews.map((r) => /* @__PURE__ */ jsxs("article", {
...
function LahoreDepartures() {
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs(Reveal, { children: [/* @__PURE__ */ jsx(SectionHeader, {
				align: "left",
				dark: true,
				eyebrow: "Departures",
				...
				children: /* @__PURE__ */ jsxs("a", {
					...
					rel: "noopener noreferrer",
					className: "inline-flex items-center gap-2 rounded-full bg-primary px-7 py-3.5 text-sm font-bold text-primary-foreground shadow-cta transition-transform hover:scale-105",
					children: ["Check Departure Availability", /* @__PURE__ */ jsx(ArrowRight, { size: 16 })]
				})
			})] }), /* @__PURE__ */ jsx(Reveal, {
				delay: 120,
				children: /* @__PURE__ */ jsx("div", {
					className: "grid gap-4",
					children: pickupPoints.map((p, i) => /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("span", {
								...
								children: [/* @__PURE__ */ jsx(MapPin, { size: 22 }), /* @__PURE__ */ jsx("span", {
			...
			children: [/* @__PURE__ */ jsx("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs(Link, {
						...
						children: ["Request Custom Tour", /* @__PURE__ */ jsx(ArrowRight, { size: 16 })]
					})
				]
			})]
		}) })
...
function HomePage() {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		/* @__PURE__ */ jsx(PopularPackages, { onBook: openBooking }),
		/* @__PURE__ */ jsx(Destinations, {}),
		/* @__PURE__ */ jsx(Inclusions, {}),
		/* @__PURE__ */ jsx(VideoSection, {}),
		/* @__PURE__ */ jsx(Testimonials, {}),
		/* @__PURE__ */ jsx(LahoreDepartures, {}),
		/* @__PURE__ */ jsx(CustomTourCTA, {}),
