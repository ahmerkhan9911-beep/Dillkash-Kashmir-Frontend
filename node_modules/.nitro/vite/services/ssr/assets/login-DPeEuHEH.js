...
import { ArrowRight, CheckCircle2, Eye, EyeOff, Loader2, Lock, Mail, MapPin, Phone, ShieldCheck, User, UserPlus } from "lucide-react";
//#region src/components/site/AuthPage.tsx
function AuthPage({ initialMode = "signin" }) {
	...
	if (success) return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-teal-900/60 backdrop-blur-sm" }), /* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		style: { backgroundImage: `url(${dest_ratti_gali_default})` },
		children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-teal-900/60 backdrop-blur-[2px]" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					...
					/* @__PURE__ */ jsxs("ul", {
						...
						children: [
							/* @__PURE__ */ jsx(CheckItem, { children: "Exclusive member pricing on tour packages" }),
							/* @__PURE__ */ jsx(CheckItem, { children: "Save trips, compare plans and book in minutes" }),
							/* @__PURE__ */ jsx(CheckItem, { children: "24/7 support from local Kashmir travel experts" })
						]
					})
				] }), /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(MapPin, {
						size: 14,
						className: "shrink-0"
					}), /* @__PURE__ */ jsx("span", { children: "Neelum Valley • Arang Kel • Ratti Gali • Taobat" })]
				})]
			}), /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(ToggleBtn, {
							active: mode === "signin",
							onClick: () => switchMode("signin"),
							icon: /* @__PURE__ */ jsx(Lock, { size: 14 }),
							children: "Sign In"
						}), /* @__PURE__ */ jsx(ToggleBtn, {
							active: mode === "signup",
							onClick: () => switchMode("signup"),
							icon: /* @__PURE__ */ jsx(UserPlus, { size: 14 }),
					...
					mode === "signin" && /* @__PURE__ */ jsxs("form", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
								...
								className: "relative",
								children: [/* @__PURE__ */ jsx(InputIcon, { children: /* @__PURE__ */ jsx(Mail, { size: 16 }) }), /* @__PURE__ */ jsx("input", {
									id: "auth-email",
									type: "email",
									value: loginEmail,
							...
							/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
								...
								className: "relative",
								children: [
									/* @__PURE__ */ jsx(InputIcon, { children: /* @__PURE__ */ jsx(Lock, { size: 16 }) }),
									/* @__PURE__ */ jsx("input", {
										id: "auth-password",
							...
							/* @__PURE__ */ jsx(SubmitBtn, {
								loading,
								children: loading ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, {
									size: 18,
									className: "animate-spin"
								}), " Signing in…"] }) : /* @__PURE__ */ jsxs(Fragment, { children: ["Sign In ", /* @__PURE__ */ jsx(ArrowRight, { size: 16 })] })
							}),
							/* @__PURE__ */ jsxs("p", {
					...
					mode === "signup" && /* @__PURE__ */ jsxs("form", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", { children: [
								...
								/* @__PURE__ */ jsxs("div", {
									className: "relative",
									children: [/* @__PURE__ */ jsx(InputIcon, { children: /* @__PURE__ */ jsx(User, { size: 16 }) }), /* @__PURE__ */ jsx("input", {
										id: "su-name",
										type: "text",
								...
								/* @__PURE__ */ jsx(FieldError, { msg: fieldErrors.full_name })
							] }),
							/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsx("label", {
									htmlFor: "su-email",
								...
								/* @__PURE__ */ jsx(FieldError, { msg: fieldErrors.email })
							] }),
							/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsx("label", {
									htmlFor: "su-phone",
								...
								/* @__PURE__ */ jsxs("div", {
									className: "relative",
									children: [/* @__PURE__ */ jsx(InputIcon, { children: /* @__PURE__ */ jsx(Phone, { size: 16 }) }), /* @__PURE__ */ jsx("input", {
										id: "su-phone",
										type: "tel",
								...
								/* @__PURE__ */ jsx(FieldError, { msg: fieldErrors.phone })
							] }),
							/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsx("label", {
									htmlFor: "su-password",
								...
								/* @__PURE__ */ jsx(FieldError, { msg: fieldErrors.password })
							] }),
							/* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsx("label", {
									htmlFor: "su-confirm",
								...
								/* @__PURE__ */ jsxs("div", {
									className: "relative",
									children: [/* @__PURE__ */ jsx(InputIcon, { children: /* @__PURE__ */ jsx(Lock, { size: 16 }) }), /* @__PURE__ */ jsx("input", {
										id: "su-confirm",
										type: "password",
								...
								/* @__PURE__ */ jsx(FieldError, { msg: fieldErrors.confirm_password })
							] }),
							/* @__PURE__ */ jsx(SubmitBtn, {
								loading,
								children: loading ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, {
									size: 18,
									className: "animate-spin"
								}), " Creating Account…"] }) : /* @__PURE__ */ jsxs(Fragment, { children: ["Create Account ", /* @__PURE__ */ jsx(ArrowRight, { size: 16 })] })
							}),
							/* @__PURE__ */ jsxs("p", {
								className: "text-center text-sm text-slate-500",
								children: [
...
var SplitComponent = () => /* @__PURE__ */ jsx(AuthPage, { initialMode: "signin" });
//#endregion
