import { n as deleteDestination, o as toggleDestinationStatus, r as getAllDestinationsAdmin } from "./destinations-DNMyGc7-.js";
import { t as DeleteConfirmDialog } from "./DeleteConfirmDialog-lvVQa56q.js";
import { useEffect, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { Edit2, Eye, EyeOff, Images, Loader2, Plus, Trash2 } from "lucide-react";
//#region src/routes/admin/destinations.index.tsx?tsr-split=component
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h1", {
				...
				children: [/* @__PURE__ */ jsx(Plus, { size: 18 }), " Create Destination"]
			})]
		}),
		...
		}) : destinations.length === 0 ? /* @__PURE__ */ jsx("div", {
			className: "rounded-3xl border border-dashed border-border bg-card p-12 text-center text-muted-foreground",
			children: /* @__PURE__ */ jsx("p", { children: "No destinations found. Create your first destination!" })
		}) : /* @__PURE__ */ jsx("div", {
			className: "grid gap-4",
			children: destinations.map((dest) => /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("div", {
						...
						children: dest.cover_image && /* @__PURE__ */ jsx("img", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("span", { children: ["Slug: ", dest.slug] }), /* @__PURE__ */ jsxs("span", { children: ["Order: ", dest.sort_order] })]
							})
						]
					}),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("button", {
								...
								children: dest.is_active ? /* @__PURE__ */ jsx(EyeOff, { size: 16 }) : /* @__PURE__ */ jsx(Eye, { size: 16 })
							}),
							/* @__PURE__ */ jsx(Link, {
