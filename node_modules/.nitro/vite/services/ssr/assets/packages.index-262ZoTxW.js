import { n as formatPKR } from "./site-Dg0SHnY9.js";
import { t as DeleteConfirmDialog } from "./DeleteConfirmDialog-lvVQa56q.js";
import { deletePackage, getAllPackagesAdmin, togglePackageStatus } from "./packages-BApqLpSW.js";
import { useEffect, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { Edit2, Eye, EyeOff, Loader2, Plus, Star, Trash2 } from "lucide-react";
//#region src/routes/admin/packages.index.tsx?tsr-split=component
	...
	return /* @__PURE__ */ jsxs("div", { children: [
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h1", {
				...
				children: [/* @__PURE__ */ jsx(Plus, { size: 18 }), " Create Package"]
			})]
		}),
		...
		}) : packages.length === 0 ? /* @__PURE__ */ jsx("div", {
			className: "rounded-3xl border border-dashed border-border bg-card p-12 text-center text-muted-foreground",
			children: /* @__PURE__ */ jsx("p", { children: "No packages yet. Create your first tour package!" })
		}) : /* @__PURE__ */ jsx("div", {
			className: "grid gap-4",
			children: packages.map((pkg) => /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("div", {
						...
						children: pkg.image && /* @__PURE__ */ jsx("img", {
							src: pkg.image,
							alt: pkg.title,
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("span", { children: [pkg.durationDays, " Days"] }),
								/* @__PURE__ */ jsx("span", { children: formatPKR(pkg.price) }),
								/* @__PURE__ */ jsxs("span", { children: ["★ ", pkg.rating] }),
								/* @__PURE__ */ jsx("span", { children: pkg.type?.join(", ") })
							]
						})]
					}),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("button", {
								...
								children: pkg.is_active ? /* @__PURE__ */ jsx(EyeOff, { size: 16 }) : /* @__PURE__ */ jsx(Eye, { size: 16 })
							}),
							/* @__PURE__ */ jsx(Link, {
