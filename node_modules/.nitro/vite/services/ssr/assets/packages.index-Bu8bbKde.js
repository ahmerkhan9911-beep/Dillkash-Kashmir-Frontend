import { r as images, s as tours } from "./site-Dg0SHnY9.js";
import { t as cn } from "./utils-C_uf36nf.js";
import { t as Route } from "./packages.index-zYMGNX-m.js";
import { t as Reveal } from "./Reveal-CRQyoRRE.js";
import { getPackages } from "./packages-BApqLpSW.js";
import { t as BookingModal } from "./BookingModal-71ZBzTEs.js";
import { t as TourCard } from "./TourCard-DhgRpgwQ.js";
import { useEffect, useMemo, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowUpDown, SlidersHorizontal } from "lucide-react";
//#region src/routes/packages.index.tsx?tsr-split=component
var durations = [
	"All",
	"3",
	"5",
...
function PackagesPage() {
	...
	const [tours$1, setTours] = useState(tours);
	...
	const [type, setType] = useState(search.type && types.includes(search.type) ? search.type : "All");
	...
	const filterGroup = (label, options, value, onChange, suffix) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		/* @__PURE__ */ jsxs("section", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-black/60 to-black/70" }),
				/* @__PURE__ */ jsxs("div", {
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("p", {
							...
							children: [/* @__PURE__ */ jsx(ArrowUpDown, {
								...
								children: sorts.map((s) => /* @__PURE__ */ jsx("option", { children: s }, s))
							})]
						})]
					})
				]
				...
				children: [filtered.map((t, i) => /* @__PURE__ */ jsx(Reveal, {
					delay: i % 3 * 70,
				...
				}, t.slug)), filtered.length === 0 && /* @__PURE__ */ jsx("p", {
