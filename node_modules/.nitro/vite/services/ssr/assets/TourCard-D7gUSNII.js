import { c as whatsappLink, n as formatPKR } from "./site-Bb-6ZWDl.js";
import { n as WhatsAppIcon } from "./Navbar-CwNINFgT.js";
import { n as StarRating } from "./BookingModal-Bahz8rgF.js";
import { useRef, useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { Calendar, ChevronLeft, ChevronRight, Clock, Images, MapPin } from "lucide-react";
//#region src/components/site/TourCard.tsx
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsx("div", {
					...
					children: imagesList.map((imgSrc, idx) => /* @__PURE__ */ jsx("div", {
				...
				/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-black/25" }),
				/* @__PURE__ */ jsxs("div", {
				...
				hasMultipleImages && /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Images, { size: 11 }), /* @__PURE__ */ jsxs("span", { children: [
						currentIndex + 1,
						"/",
						imagesList.length
					] })]
				...
				hasMultipleImages && /* @__PURE__ */ jsxs(Fragment, { children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: imagesList.map((_, dotIdx) => /* @__PURE__ */ jsx("button", {
							type: "button",
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: tour.destinations.slice(0, 4).map((d) => /* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx(MapPin, { size: 10 }), d]
					}, d))
				}),
				/* @__PURE__ */ jsxs("div", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Link, {
						...
						children: [/* @__PURE__ */ jsx(WhatsAppIcon, { size: 15 }), "Book Now"]
					})]
				})
			]
		})]
