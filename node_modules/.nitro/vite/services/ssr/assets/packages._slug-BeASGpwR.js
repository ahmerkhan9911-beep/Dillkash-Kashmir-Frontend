import { c as whatsappLink, i as pickupPoints, n as formatPKR, o as site } from "./site-Bb-6ZWDl.js";
import { t as cn } from "./utils-C_uf36nf.js";
import { n as WhatsAppIcon } from "./Navbar-CwNINFgT.js";
import { t as Route } from "./packages._slug-BhN2FQs7.js";
import { t as Reveal } from "./Reveal-CRQyoRRE.js";
import { getPackageBySlug } from "./packages-BxcyjwUZ.js";
import { n as StarRating, t as BookingModal } from "./BookingModal-Bahz8rgF.js";
import { useEffect, useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { BedDouble, Bus, Calendar, Check, ChevronDown, Clock, HandPlatter, Loader2, MapPin, Phone, Users, X } from "lucide-react";
//#region src/routes/packages.$slug.tsx?tsr-split=component
var quickInfo = (tour) => [
	{
		icon: Clock,
		label: "Duration",
				...
				children: [/* @__PURE__ */ jsxs("button", {
					...
					children: /* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx("ul", {
							...
							children: day.details.map((d) => /* @__PURE__ */ jsxs("li", {
...
function TourDetailPage() {
	...
	const [tour, setTour] = useState(loaderData.tour);
	...
	if (loading || !tour) return /* @__PURE__ */ jsx("div", {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		/* @__PURE__ */ jsxs("section", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-black/60 via-black/40 to-black/75" }),
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("span", {
									className: "inline-flex items-center gap-1.5 rounded-full bg-white/15 px-3.5 py-1.5 backdrop-blur",
									children: [/* @__PURE__ */ jsx(MapPin, { size: 14 }), " Departs Lahore"]
								}),
								/* @__PURE__ */ jsxs("span", {
									className: "inline-flex items-center gap-1.5 rounded-full bg-white/15 px-3.5 py-1.5 backdrop-blur",
									children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("a", {
									...
									children: [/* @__PURE__ */ jsx(WhatsAppIcon, { size: 18 }), "WhatsApp"]
								})
							]
						})
					]
			...
			children: [
				...
				/* @__PURE__ */ jsxs(Reveal, {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						className: "mt-6",
						children: /* @__PURE__ */ jsx(ItineraryAccordion, { itinerary: tour.itinerary })
					})]
				}),
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("h2", {
							...
							children: tour.included.map((item) => /* @__PURE__ */ jsxs("li", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("h2", {
								...
								className: "mt-4 space-y-3",
								children: tour.notIncluded.map((item) => /* @__PURE__ */ jsxs("li", {
									className: "flex items-start gap-3 text-sm text-muted-foreground",
									children: [/* @__PURE__ */ jsx("span", {
				...
				/* @__PURE__ */ jsxs(Reveal, {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						children: pickupPoints.map((p) => /* @__PURE__ */ jsxs("div", {
				...
				/* @__PURE__ */ jsxs(Reveal, {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						children: tour.gallery.map((img, i) => /* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("h2", {
							...
							children: [/* @__PURE__ */ jsx("button", {
								...
								children: [/* @__PURE__ */ jsx(Phone, { size: 16 }), site.phone]
							})]
						})]
					})
				})
