...
import { a as dest_muzaffarabad_default, c as dest_sharda_default, i as dest_kutton_default, l as dest_taobat_default, n as dest_dhani_default, o as dest_neelum_river_default, r as dest_keran_default, s as dest_pir_chinasi_default, t as dest_arang_kel_default, u as video_thumb_default } from "./dest-muzaffarabad-DnLEGoZs.mjs";
import { t as dest_ratti_gali_default } from "./dest-ratti-gali-B7IFeZhf.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/site-Bb-6ZWDl.js
var site = {
	...
	whatsappMessage: "Hi Al Kareem Travel, I want details regarding Kashmir Tour departing from Lahore.",
	email: "info@alkareemtravel.pk",
	address: "Main Boulevard, Johar Town, Lahore, Pakistan",
	hours: "Mon – Sun: 9:00 AM – 10:00 PM"
};
var whatsappLink = (message = site.whatsappMessage) => `https://wa.me/${site.whatsapp}?text=${encodeURIComponent(message)}`;
var images = {
	heroKashmir: hero_kashmir_default,
	videoThumb: video_thumb_default,
	arangKel: dest_arang_kel_default,
	neelumRiver: dest_neelum_river_default,
	sharda: dest_sharda_default,
	rattiGali: dest_ratti_gali_default,
	taobat: dest_taobat_default,
	pirChinasi: dest_pir_chinasi_default,
	kutton: dest_kutton_default,
	dhani: dest_dhani_default,
	keran: dest_keran_default,
	muzaffarabad: dest_muzaffarabad_default
};
var pickupPoints = [
	{
...
var tours = [
	{
		...
		gallery: [
			dest_keran_default,
			dest_neelum_river_default,
			dest_muzaffarabad_default,
			dest_dhani_default
		]
	},
	{
	...
	},
	{
		...
		itinerary: [
			{
				day: 1,
				title: "Lahore to Neelum Valley",
				details: [
					"Night departure from Lahore",
					"Morning arrival, breakfast in Muzaffarabad",
					"Drive to Keran, riverside evening"
				]
			},
			{
				day: 2,
				title: "Keran to Sharda",
				details: [
					"Breakfast at Keran",
					"Scenic drive to Sharda",
					"Sharda ruins & river view point",
					"Night stay at Sharda"
				]
			},
			{
				day: 3,
				title: "Ratti Gali Base Camp",
				details: [
					"4x4 jeep departure to Ratti Gali base camp",
					"Trek / horse ride to Ratti Gali Lake",
					"Lakeside camping under the stars"
				]
			},
			{
				day: 4,
				title: "Ratti Gali to Kel",
				details: [
					"Sunrise at the lake",
					"Descend to base camp",
					"Drive to Kel, evening at leisure"
				]
			},
			{
				day: 5,
				title: "Taobat Expedition",
				details: [
					"Full-day 4x4 expedition to Taobat",
					"The last village of Neelum Valley",
					"Return to Kel for overnight stay"
				]
			},
			{
				day: 6,
				title: "Baboon Valley",
				details: [
					"Day trip to Baboon Valley meadows",
					"Picnic lunch & photography",
					"Farewell dinner at Sharda"
				]
			},
			{
				day: 7,
				...
				details: [
					"Breakfast & checkout",
					"Return journey with waterfall photo stops",
					"Late-night arrival in Lahore"
				]
			}
		],
		gallery: [
			dest_ratti_gali_default,
			dest_taobat_default,
			video_thumb_default,
			dest_sharda_default
		]
	},
	{
		...
		rating: 4.8,
		reviews: 96,
		image: dest_neelum_river_default,
		destinations: [
			"Keran",
			"Sharda",
			"Upper Neelum"
		...
		itinerary: [
			{
				day: 1,
				title: "Lahore to Keran",
				details: [
					"Overnight journey from Lahore",
					"Riverside check-in at Keran",
					"Private dinner by the Neelum River"
				]
			},
			{
				day: 2,
				title: "Keran Leisure Day",
				details: [
					"Late breakfast",
					"Upper Neelum viewpoint",
					"Bonfire evening for two"
				]
			},
			{
				day: 3,
				title: "Sharda Day Trip",
				details: [
					"Scenic drive to Sharda",
					"Ruins & river photography",
					"Candle-light dinner"
				]
			},
			{
				day: 4,
				title: "Return to Lahore",
				details: ["Breakfast & checkout", "Return journey to Lahore"]
			}
		],
		gallery: [
			dest_neelum_river_default,
	...
	},
	{
		...
		itinerary: [
			...
			},
			{
				...
				details: [
					"Drive to Kutton",
					"Waterfall visit & family picnic",
					"Night stay at Kutton"
				]
			},
			{
				day: 3,
				title: "Sharda Exploration",
				details: [
					"Sharda ruins & bazaar",
					"Riverside evening",
					"Night stay at Sharda"
			...
			},
			{
				day: 5,
				title: "Return to Lahore",
				details: ["Breakfast & departure", "Late-night arrival in Lahore"]
			}
		],
		gallery: [
			dest_sharda_default,
	...
	},
	{
		...
		rating: 4.8,
		reviews: 63,
		image: dest_muzaffarabad_default,
		destinations: [
			"Muzaffarabad",
			"Pir Chinasi",
			"Keran"
		...
		itinerary: [
			...
			{
				day: 2,
				title: "Pir Chinasi & Keran",
				details: [
					"Pir Chinasi sunrise viewpoint",
					"Drive to Keran",
					"Bonfire & team activities"
				]
			},
			{
				day: 3,
				title: "Return to Lahore",
				details: ["Breakfast & group photos", "Return journey to Lahore"]
			}
		],
		gallery: [
			dest_muzaffarabad_default,
			dest_pir_chinasi_default,
			dest_keran_default
		]
	}
];
...
var reviews = [
	{
		...
		initials: "AR",
		rating: 5,
		review: "Booked the 5-day tour from Kalma Chowk. Coaster was comfortable, hotels were clean and our guide Bilal bhai managed everything perfectly. Arang Kel was beyond words.",
	...
	},
	{
		...
		initials: "FU",
		rating: 5,
		review: "Our honeymoon trip was beautifully arranged — private riverside room in Keran, candle-light dinner, everything on time. Highly recommended for couples!",
	...
	},
	{
		...
		initials: "MB",
		rating: 5,
		review: "Took the office team on the corporate retreat. Dedicated coaster, great food, and the Pir Chinasi sunrise was the highlight. Very professional management.",
	...
	},
	{
		...
		initials: "AK",
		rating: 4,
		review: "Traveled with two kids on the family retreat. Separate family rooms and patient guides made it stress-free. Kutton Waterfall was magical for the children.",
	...
	},
	{
		...
		initials: "HJ",
		rating: 5,
		review: "Ratti Gali has been on my list for years. The 4x4 ride, the camping, the lake at sunrise — Al Kareem nailed every detail. Worth every rupee.",
	...
	},
	{
		...
		initials: "ST",
		rating: 5,
		review: "Weekend Neelum trip was smooth from pickup to drop-off. Transparent pricing — no surprise charges. Already planning Taobat with them next month!",
		trip: "3-Day Express Neelum Valley & Keran Tour"
	}
];
var formatPKR = (amount) => `PKR ${amount.toLocaleString("en-PK")}`;
//#endregion
export { reviews as a, whatsappLink as c, pickupPoints as i, formatPKR as n, site as o, images as r, tours as s, destinations as t };
