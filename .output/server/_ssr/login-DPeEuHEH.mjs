...
import { A as Mail, C as Phone, J as EyeOff, N as Lock, P as LoaderCircle, Z as CircleCheck, a as User, h as ShieldCheck, k as MapPin, o as UserPlus, q as Eye, ut as ArrowRight } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/login-DPeEuHEH.js
...
function AuthPage({ initialMode = "signin" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-teal-900/60 backdrop-blur-[2px]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "relative flex w-full max-w-5xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl sm:rounded-3xl md:flex-row",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "relative flex w-full shrink-0 flex-col justify-between bg-[#064E3B] px-4 py-4 text-white sm:px-6 sm:py-5 md:w-[45%] md:shrink md:px-10 md:py-10",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "text-lg font-bold leading-tight sm:text-xl md:text-3xl",
						children: "Your Kashmir journey starts here."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-1 hidden text-sm leading-relaxed text-emerald-200/80 sm:mt-2 sm:block md:mt-4",
						children: "One account for curated packages, custom tours and member-only deals across the valley."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", {
						className: "mt-4 hidden space-y-4 md:mt-8 md:block",
						children: [
					...
					className: "mt-3 hidden items-center gap-2 text-xs text-emerald-300/60 md:mt-10 md:flex",
				...
				className: "flex w-full flex-col justify-center overflow-y-auto bg-white px-4 py-5 sm:p-6 md:w-[55%] md:p-10 lg:p-12",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mx-auto mb-5 flex w-fit rounded-full bg-gray-100 p-1 sm:mb-8",
