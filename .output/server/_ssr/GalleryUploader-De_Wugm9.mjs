...
import { A as Link, M as Image, P as ImagePlus, V as CircleAlert, g as RefreshCw, k as LoaderCircle, s as Trash2, t as X } from "../_libs/lucide-react.mjs";
import { i as uploadImage } from "./api-CJHRqUur.mjs";
import { t as resolveImageUrl } from "./resolveImage-CClln7-6.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/GalleryUploader-De_Wugm9.js
...
function ImageUploader({ value, onChange, onUploadingChange, label = "Image" }) {
	...
	const [pasteMode, setPasteMode] = (0, import_react.useState)(false);
	const [localBlob, setLocalBlob] = (0, import_react.useState)(null);
	...
	const setUploadingState = (0, import_react.useCallback)((v) => {
		setUploading(v);
		onUploadingChange?.(v);
	}, [onUploadingChange]);
	...
	const onDragLeave = (0, import_react.useCallback)(() => setDragging(false), []);
	...
	const onFileChange = (0, import_react.useCallback)((e) => {
	...
	if (pasteMode) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
	...
	if (displaySrc) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
			className: labelCls,
			children: label
		}),
			...
			children: [
				...
				!uploading && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						title: "Replace image",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RefreshCw, { size: 12 }), "Replace"]
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, { size: 12 }), "or paste image URL instead"]
		})
	] });
}
var ALLOWED_TYPES = [
